    ...
    <>
      <div className="flex flex-col gap-8">
        ...
        <DataTablePaginated
          ...
          exportPdfConfig={{ title: "Listado de turnos", filename: "turnos.pdf", formatters, headers }}
          exportXlsConfig={{ filename: "turnos.xlsx", formatters, headers, sheetName: "Turnos" }}
          loading={isLoading}
